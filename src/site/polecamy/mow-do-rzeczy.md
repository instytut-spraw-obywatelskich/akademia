...
zajawka: 10 lat temu wspólnie z Janem Herbstem napisaliśmy i wydaliśmy w Stoczni
  książkę pod tym właśnie tytułem – „Mów do rzeczy”. Jest ona w dalszym ciągu
  dostępna bezpłatnie na stronach Stoczni. Mówi o tym, w jaki sposób organizacje
  społeczne mogę korzystać z danych – jak je pozyskiwać, rozumieć, używać itd.
  Wszystkie poruszane w niej wątki zachowują aktualność. Siłą rzeczy jest ona
  znacznie bardziej rozbudowana (np. poprzez zawarte w niej porady
